...
describe('Graphic Types', function() {
    ...
    describe('gpoint_equal', function() {
        ...
        it("works for common cases", function () {
            ...
            expect(gpoint_equal([10, 10], [10, 10])).to.be.true; // jshint ignore:line
            expect(gpoint_equal([10, 10], [5, 7])).to.be.false; // jshint ignore:line
        });
    });
    describe('grect_equal', function() {
        var grect_equal = rocky.grect_equal;
        it("works for common cases", function() {
            expect(grect_equal([1, 2, 3, 4], [1, 2, 3, 4])).to.be.true; // jshint ignore:line
            expect(grect_equal([1, 2, 3, 4], [1, 2, 3, 5])).to.be.false; // jshint ignore:line
        });
    });
    describe('grect_is_emtpy', function() {
        var grect_is_emtpy = rocky.grect_is_emtpy;
        it("works for common cases", function() {
            expect(grect_is_emtpy([1, 2, 0, 0])).to.be.true; // jshint ignore:line
            expect(grect_is_emtpy([1, 2, 3, 4])).to.be.false; // jshint ignore:line
        });
    });
    ...
    describe('grect_contains_point', function() {
        ...
        it("works for common cases", function() {
            expect(grect_contains_point([10, 10, 5, 5], [12, 12])).to.be.true; // jshint ignore:line
            expect(grect_contains_point([10, 10, 5, 5], [5, 12])).to.be.false; // jshint ignore:line
        });
    });
    ...
    describe('gpoint_from_polar', function() {
        ...
        it("works for common cases", function() {
            var pt = gpoint_from_polar([10, 20, 30, 40], rocky.GOvalScaleModeFitCircle, Math.PI);
    ...
    describe('grect_centered_from_polar', function() {
        ...
        it("works for common cases", function() {
            var rect = grect_centered_from_polar([10, 20, 30, 40], rocky.GOvalScaleModeFitCircle, Math.PI, [4, 5]);
